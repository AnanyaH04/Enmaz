    ...
    <Fragment>
      ...
      <div className="New-Schedule-popUp">
        <Grid container spacing={3}>
          ...
          <Grid item md={6} xs={12}>
            <FormControl fullWidth>
              <Dropdown
                ...
                selectData={engineer}
                icon={<EngineeringOutlinedIcon className="iconInSelect" />}
          ...
          <Grid item md={6} xs={12}>
            <FormControl fullWidth>
              {/* <dateSelector name ="Select Start Date"/> */}
              <input
          ...
          <Grid item md={6} xs={12}>
            <FormControl fullWidth>
              <input
                ...
                onBlur={(e) => (e.target.type = "text")}
              />
              {/* <dateSelector name= "Select End Date" /> */}
              {/* <p>end</p> */}
            </FormControl>
          </Grid>
          <Grid item md={6} xs={12}>
            <FormControl fullWidth>
              <Dropdown
                ...
                icon={<GraphicEqIcon className="iconInSelect" />}
